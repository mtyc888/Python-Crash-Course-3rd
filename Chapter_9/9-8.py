...
admin.describe_user()
admin.priviledges.show_priv()

print("Adding priviledges...")
admin_priviledges = ['Can add user', 'Can delete User', 'Can update User']

admin.priviledges.priviledges = admin_priviledges
admin.priviledges.show_priv()